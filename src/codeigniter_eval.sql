/*
 ...
 Source Schema         : codeigniter_eval
...
) ENGINE = MyISAM AUTO_INCREMENT = 497 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 1703 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `film`  (
  ...
  `rating` enum('G','PG','PG-13','R','NC-17') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'G',
  `special_features` set('Trailers','Commentaries','Deleted Scenes','Behind the Scenes') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `last_update` timestamp NOT NULL DEFAULT current_timestamp ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `orders`  (
  ...
  `status` enum('Cancelled','Disputed','In Process','On Hold','Resolved','Shipped') CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `comments` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL,
  `customerNumber` int NOT NULL,
  PRIMARY KEY (`orderNumber`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 10426 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `users`  (
  ...
  `full_name` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
